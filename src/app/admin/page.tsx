          ...
          <main className="flex-1 overflow-y-auto bg-gradient-to-b from-transparent to-[#f4f7ff] dark:from-slate-900 dark:to-slate-950 px-6 py-6">
            ...
            <section className="mt-5 grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-4">
              <StatCard
                ...
                value="5"
                badge="+2"
                iconClassName="bg-[#E5EEFF] text-[#2062FF]"
              />
              <StatCard
                ...
                value="47"
                badge="+8"
                iconClassName="bg-[#F1E4FF] text-[#9B51FF]"
              />
              <StatCard
                ...
                value="$1,249"
                badge="+12%"
                iconClassName="bg-[#E2F6F0] text-[#1A9D63]"
              />
              <StatCard
                ...
                value="99.9%"
                badge="Stable"
                iconClassName="bg-[#F2F4F7] text-slate-800"
              />
            </section>
            ...
            <section className="mt-8">
              ...
              <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
                ...
                <ApplicationCard
                  ...
                  onClick={() => setShowLiveCAModal(true)}
                />
                <ApplicationCard
